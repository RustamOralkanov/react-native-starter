    ...
    return (
        <Svg width="24" height="24" viewBox="0 0 24 24" fill="none" {...props}>
            <Path
                ...
                fill="url(#paint0_linear_2389_19845)"
            />
            <Path
            ...
            />
            <Defs>
                <LinearGradient id="paint0_linear_2389_19845" x1="8.5" y1="2" x2="22" y2="28" gradientUnits="userSpaceOnUse">
                    <Stop stopColor="#B8B8B8" />
                    <Stop offset="1" stopColor="#B8B8B8" stopOpacity="0.1" />
                </LinearGradient>
            </Defs>
        </Svg>
    );
